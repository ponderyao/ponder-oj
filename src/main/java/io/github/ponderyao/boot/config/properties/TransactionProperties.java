package io.github.ponderyao.boot.config.properties;
...
public class TransactionProperties {
    ...
    public static final String DEFAULT_POINTCUT_EXPRESSION = "execution (io.github.ponderyao.boot.controller..*.*(..))";
